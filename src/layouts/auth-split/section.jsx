      ...
      icon: (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_2300_7127)">
            <path d="M17.9904 0.5C27.6501 0.5 35.4808 8.33073 35.4808 17.9904V18.0096C35.4808 27.6693 27.6501 35.5 17.9904 35.5C8.33073 35.5 0.5 27.6693 0.5 18.0096V17.9904C0.5 8.33073 8.33073 0.5 17.9904 0.5Z" fill="#F3DAFF" stroke="white" />
            <path fillRule="evenodd" clipRule="evenodd" d="M18 9C25.4115 9 27 10.3333 27 17C27 21.3333 26.2501 24 22.8752 24C21.0716 24 20.5351 24.8568 20.0355 25.6546C19.6002 26.3497 19.1929 27 18.0002 27C16.8075 27 16.4003 26.3497 15.9649 25.6546C15.4653 24.8568 14.9288 24 13.1252 24C9.75021 24 9 21.248 9 17C9 10.412 10.5885 9 18 9ZM18.75 15C18.75 14.5858 19.0858 14.25 19.5 14.25H21.75C22.1642 14.25 22.5 14.5858 22.5 15C22.5 15.4142 22.1642 15.75 21.75 15.75H19.5C19.0858 15.75 18.75 15.4142 18.75 15ZM14.25 17.25C13.8358 17.25 13.5 17.5857 13.5 18C13.5 18.4143 13.8358 18.75 14.25 18.75H21.75C22.1642 18.75 22.5 18.4143 22.5 18C22.5 17.5857 22.1642 17.25 21.75 17.25H14.25Z" fill="#A21FDF" />
          </g>
          <defs>
